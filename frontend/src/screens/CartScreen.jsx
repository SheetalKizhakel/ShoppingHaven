//the screen which should open after add to cart
//useNavigate is used to navigate back to previous page
...
//the screen is divided vertically into 12 columns
...
const CartScreen = () => {
    ...
    const removeFromCartHandler=async(id)=>{
        dispatch(removeFromCart(id));//whatever we pass in here is what is passed as the action payload
