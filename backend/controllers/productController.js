...
const getProducts=asyncHandler(async(req,res)=>{
    ...
    const page=Number(req.query.pageNumber)||1;//for pagination
    const keyword=req.query.keyword?{name:{$regex:req.query.keyword, $options:'i'}}:{};//for searching product
...
//access- Private-- private means you will have to be logged in
